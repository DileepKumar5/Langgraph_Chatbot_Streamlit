...
from langgraphbackendsimple import workflow  # Our chatbot brain (the LangGraph that talks to the LLM)
...
if 'chat_threads' not in st.session_state:  # chat_threads = list of all our conversation IDs (for the sidebar)
    st.session_state['chat_threads'] = []  # Start with an empty list; we'll add IDs when user starts new chats
